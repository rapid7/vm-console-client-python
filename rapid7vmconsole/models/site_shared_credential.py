...
class SiteSharedCredential(object):
    ...
    def service(self, service):
        ...
        :type: str
        """
        allowed_values = ["as400", "cifs", "cifshash", "cvs", "db2", "ftp", "http", "ms-sql", "mysql", "notes", "oracle", "pop", "postgresql", "remote-exec", "snmp", "snmpv3", "ssh", "ssh-key", "sybase", "telnet", "kerberos"]  # noqa: E501
